...
import { Dimensions, Text, StyleSheet, View, Image, TouchableOpacity, TextInput,Modal } from 'react-native';
...
const ModalView = ({ text, headertext, placeholder, data,visible,closeModal }: Props) => {
    return (
        <Modal
            animationType="slide"
            transparent={true}
                ...
                <View style={styles.bottomView}>
                    <View style={styles.bottomRow}>
                        ...
                        <Button type={Constant.buttons.DESKTOP}
                            text={text} style={styles.primaryButton} />
                        <Button type={Constant.buttons.SECONDARY}
                            text={"Close"} style={styles.closeButton} />
