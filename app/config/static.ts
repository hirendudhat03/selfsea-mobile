export const auths = {
    ...
    SIGNUP_AGREEMENT_L1:"by signing up for selfsea, you are agreeing to the",
...
export const modalBoxes = {
    TITLES:{
        USERNAME: 'selfsea usernames',
        BIRTH_MONTH: 'selfsea birth month'
    },
    SMALL_TEXTS:{
        USERNAME: 'your username will need to be approved by a moderator before your first post or comment can be approved. it can not be changed after that.'
    },
